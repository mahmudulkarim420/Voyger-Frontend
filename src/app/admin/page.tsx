    ...
    <div className="space-y-8 w-full pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">Here is today&apos;s store order fulfillment and operational summary</p>
        </div>
          ...
          <div>
            ...
            <div className="mt-4 h-20 w-full overflow-hidden">
              <svg viewBox="0 0 200 60" className="w-full h-full">
                <defs>
                  <linearGradient id="waveGradAdmin" x1="0" y1="0" x2="0" y2="1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        {/* CARD 4 (8 COLS): PAYMENT HISTORY TABLE */}
