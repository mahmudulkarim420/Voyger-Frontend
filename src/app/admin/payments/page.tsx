...
export default function AdminPaymentsPage() {
  ...
  return (
    <div className="space-y-6 w-full pb-12">
      <PageHeader
        title="Operational Payment Transactions"
        description="Monitor customer payment verification status and transaction references"
      ...
      <SearchToolbar
        ...
        searchPlaceholder="Search transaction ref, order ID, or customer..."
      />
