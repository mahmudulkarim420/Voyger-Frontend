...
import { Edit, ArrowLeft, Package, Tag, Star, DollarSign } from "lucide-react";
...
export default function SuperAdminProductDetailPage() {
  ...
  useEffect(() => {
    fetchApi(`products/${id}`).then((res) => {
      if (res.success && res.data) {
        ...
        setProduct({
          id,
          name: "Classic Panjabi Collection Item",
  ...
  return (
    <div className="space-y-6 w-full max-w-4xl pb-12">
      ...
      >
        <Link
          href={`/super-admin/products/${id}/edit`}
