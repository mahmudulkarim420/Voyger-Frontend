...
import { ArrowLeft, Printer, User, MapPin, CreditCard, PackageCheck } from "lucide-react";
  ...
  return (
    <div className="space-y-6 w-full max-w-4xl pb-12">
      <PageHeader
        ...
        breadcrumbs={[
          { label: "Orders", href: "/super-admin/orders" },
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        {/* Left: Items List & Payment Summary (8 COLS) */}
        ...
        {/* Right: Customer Info & Status Switch (4 COLS) */}
