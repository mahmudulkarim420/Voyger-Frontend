  ...
  return (
    <div className="space-y-6 w-full pb-12">
      <PageHeader
        ...
        description="Organize platform taxonomy, parent hierarchy, and featured collections"
      ...
      <ConfirmationDialog
        ...
        message="Are you sure you want to delete this category? Products mapped to this category will need re-assignment."
