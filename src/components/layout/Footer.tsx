...
export const Footer = () => {
  return (
    <footer className="bg-[#F4EBE4] pt-16 mt-auto">
      <div className="container mx-auto px-4 lg:px-8 pb-16 grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12">
        ...
        <div className="md:col-span-3">
          <Link href="/" className="flex items-center gap-3">
            ...
            <span className="text-[22px] font-medium tracking-[0.2em] mt-1 text-black">
              VOYΛGE
            </span>
          </Link>
        </div>
        ...
        {/* Our Info */}
        <div className="md:col-span-3">
          <h4 className="font-semibold mb-6 text-[15px] uppercase tracking-widest text-gray-900">OUR INFO</h4>
          <ul className="space-y-4 text-[15px] text-gray-800">
            ...
            <li><Link href="/find-store" className="hover:text-black transition-colors">Find Store</Link></li>
          </ul>
        </div>

        {/* Policies */}
        <div className="md:col-span-3">
          <h4 className="font-semibold mb-6 text-[15px] uppercase tracking-widest text-gray-900">POLICIES</h4>
          <ul className="space-y-4 text-[15px] text-gray-800">
            <li><Link href="/privacy-policy" className="hover:text-black transition-colors">Privacy Policy</Link></li>
            <li><Link href="/return-refund" className="hover:text-black transition-colors">Return & Refund Policy</Link></li>
            <li><Link href="/terms-of-service" className="hover:text-black transition-colors">Terms Of Service</Link></li>
            <li><Link href="/contact-info" className="hover:text-black transition-colors">Contact Information</Link></li>
          </ul>
        </div>

        {/* Contact Us */}
        <div className="md:col-span-3">
          <h4 className="font-semibold mb-6 text-[15px] uppercase tracking-widest text-gray-900">CONTACT US</h4>
          <ul className="space-y-4 text-[15px] text-gray-800">
            <li className="uppercase tracking-widest text-[13px] text-gray-900">FOR ANY HELP YOU MAY CALL US AT</li>
            <li><strong>Phone:</strong> +880 9639279055</li>
            <li><strong>Email:</strong> Info@Voyagetm.Com</li>
      ...
      {/* Bottom Bar */}
      <div className="border-t border-[#D5C1B6]">
        <div className="container mx-auto px-4 lg:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-3 items-center">
            ...
            <div className="bg-[#006FCF] px-2 py-1 rounded shadow-sm flex items-center justify-center w-[46px] h-[28px]">
              <span className="font-bold text-[8px] leading-none text-center text-white">AM<br/>EX</span>
            </div>
            {/* Diners / Discover */}
            <div className="bg-white px-2 py-1 rounded shadow-sm flex items-center justify-center w-[46px] h-[28px]">
               <svg viewBox="0 0 24 24" className="h-5" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M14.5 12c0-1.38-1.12-2.5-2.5-2.5S9.5 10.62 9.5 12s1.12 2.5 2.5 2.5 2.5-1.12 2.5-2.5z" fill="white"/>
              </svg>
            </div>
          </div>
        </div>
